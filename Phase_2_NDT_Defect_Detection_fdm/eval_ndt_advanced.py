...
def eval_ndt_advanced(data_dir='NDT_Data_V2'):
    ...
    defect_mask_rect = ((X > 0.64) & (X < 0.76) & (Y > 0.56) & (Y < 0.74))
    defect_mask = defect_mask_circle | defect_mask_rect
    ...
    rectangle = Rectangle((0.64, 0.56), 0.12, 0.18, color='red', fill=False, linewidth=2, linestyle='--')
